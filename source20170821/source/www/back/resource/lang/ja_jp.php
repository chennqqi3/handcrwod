...
$g_err_msgs = array(
	...
	ERR_ALREADY_USING_LOGIN_ID => "このユーザーIDは既に利用されています。他のユーザーIDを入力してください。",
	ERR_ALREADY_USING_EMAIL => "このメールアドレスは既に利用されています。他のメールアドレスを入力してください。",
	...
	ERR_INVALID_INVITE_KEY => "招待キーが有効ではありません。",

	ERR_ALREADY_USING_EMOTICON => "この絵文字のコードは利用中です。",

	ERR_NOTFOUND_CMSG => "メッセージが存在しません。",
	ERR_NOTFOUND_EMOTICON => "絵文字が存在しません。"
);
