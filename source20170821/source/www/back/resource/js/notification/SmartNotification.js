        ...
        if (settings.input != undefined) {
            ...
            case "select|input":
                if (settings.options == undefined) {
                    ...
                    InputType = "<select class='form-control' id='sel" + SmartMSGboxCount + "'>";
                    for (var i = 0; i <= settings.options.length - 1; i++) {
                        if (settings.options[i] == "[") {
                            Name = "";
                        } else {
                    ...
                    InputType += "</select>";
					InputType += "<br/><br/><input class='form-control' type='text' id='txt" +
						SmartMSGboxCount + "' placeholder='" + settings.placeholder + "'/><br/><br/>";
                }
        ...
        $(".botTempo").click(function () {
            ...
            if (HasInput == 1) {
                if (typeof callback == "function") {
					...
					if (settings.input == "select|input") {
						var sel_val = $("#sel" + IDNumber).val();
						if (sel_val != "")
						{
							Value = sel_val + "\n" + Value;
						}
        ...
        if (settings.timeout != undefined) {
            ...
            setTimeout(function () {
                ...
                if ($("#" + CurrentIDSmallbox + ":hover").length != 0) {
                    ...
                    $("#" + CurrentIDSmallbox).bind("mouseleave", function () {
                        SmallBoxesAnchos = SmallBoxesAnchos - ThisHeight;
                        $("#" + CurrentIDSmallbox).remove();
                        if (typeof callback == "function") {
                            if (callback)
