...
(function() {
  angular.module('ionic.rating', []).constant('ratingConfig', {
    ...
    return {
      ...
      template: '<ul class="rating" ng-mouseleave="reset()" ng-keydown="onKeydown($event)">' + '<li ng-repeat="r in range track by $index" ng-click="rate($index + 1)"><i class="icon" ng-class="$index < value && (r.stateOn || \'ion-ios-heart\') || (r.stateOff || \'ion-ios-heart-outline\')"></i></li>' + '</ul>',
      replace: true,
