...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="styles/main.css?v=2.9.6">
    ...
    <body data-ng-app="app" id="app" data-custom-background>
        ...
        <script src="scripts/vendor.js?v=2.9.6"></script>

        <script src="scripts/ui.js?v=2.9.6"></script>

        <script src="scripts/config.js?v=2.9.6.1"></script>

        <script src="scripts/app.js?v=2.9.6.1"></script>
    </body>
</html>